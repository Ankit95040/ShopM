        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 sm:p-4">
          <div className="w-full max-w-md rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleEditSubmit} className="mt-4 space-y-3">
              ...
              {editingTx.type==="DEBT" ? (
                <div><label className="text-xs font-bold text-slate-700">Bill No</label><input value={editBillNo} onChange={e=>setEditBillNo(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" /></div>
              ): (
                <div><label className="text-xs font-bold text-slate-700">Payment Method</label><select value={editPaymentMethod} onChange={e=>setEditPaymentMethod(e.target.value as PaymentMethod)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs font-bold"><option value={PaymentMethod.CASH}>Cash</option><option value={PaymentMethod.UPI}>UPI</option><option value={PaymentMethod.BANK_TRANSFER}>Bank</option><option value={PaymentMethod.OTHER}>Other</option></select></div>
              )}
              <div><label className="text-xs font-bold text-slate-700">Description</label><input value={editDesc} onChange={e=>setEditDesc(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" /></div>
              <div><label className="text-xs font-bold text-slate-700">Change reason *</label><input value={editChangeReason} onChange={e=>setEditChangeReason(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" required /></div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 sm:p-4">
          <div className="w-full max-w-md rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddDebt} className="mt-4 space-y-3">
              <div><label className="text-xs font-bold text-slate-700">Amount *</label><input type="number" step="0.01" value={debtAmount} onChange={e=>setDebtAmount(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-base font-black text-red-600 focus:border-slate-900 focus:outline-none" required /></div>
              <div><label className="text-xs font-bold text-slate-700">Bill No</label><input value={debtBillNo} onChange={e=>setDebtBillNo(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" /></div>
              <div><label className="text-xs font-bold text-slate-700">Description</label><input value={debtDesc} onChange={e=>setDebtDesc(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" /></div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 sm:p-4">
          <div className="w-full max-w-md rounded-2xl sm:rounded-3xl bg-white p-5 sm:p-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddPayment} className="mt-4 space-y-3">
              ...
              <div><label className="text-xs font-bold text-slate-700">Payment Method</label><select value={paymentMethod} onChange={e=>setPaymentMethod(e.target.value as PaymentMethod)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs font-bold"><option value={PaymentMethod.CASH}>Cash</option><option value={PaymentMethod.UPI}>UPI</option><option value={PaymentMethod.BANK_TRANSFER}>Bank</option><option value={PaymentMethod.OTHER}>Other</option></select></div>
              <div><label className="text-xs font-bold text-slate-700">Description</label><input value={paymentDesc} onChange={e=>setPaymentDesc(e.target.value)} className="mt-1 w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs focus:border-slate-900 focus:outline-none" /></div>
